...
export class Configuration {
  ...
  constructor({accessToken, apiKeys, basePath, credentials, encodeParam, encoder, password, username, withCredentials}: ConfigurationParameters = {}) {
    ...
    // init default Pizzeria.Fabulosa.ACCESS_TOKEN credential
    if (!this.credentials['Pizzeria.Fabulosa.ACCESS_TOKEN']) {
      this.credentials['Pizzeria.Fabulosa.ACCESS_TOKEN'] = () => {
        if (this.apiKeys === null || this.apiKeys === undefined) {
          return undefined;
        } else {
          return this.apiKeys['Pizzeria.Fabulosa.ACCESS_TOKEN'] || this.apiKeys['Pizzeria.Fabulosa.ACCESS_TOKEN'];
        }
      };
    }
  }
