...
constructor({ accessToken, apiKeys, basePath, credentials, encodeParam, encoder, password, username, withCredentials }: ConfigurationParameters = {}) {
        ...
        // init default Bearer_Authentication credential
        if (!this.credentials['Bearer_Authentication']) {
            this.credentials['Bearer_Authentication'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['Bearer_Authentication'] || this.apiKeys['Pizzeria.Fabulosa.ACCESS_TOKEN'];
                }
            };
        }
    }
